...
public class SimpleConnectionPoolDataSource implements DataSource {
    ...
    public SimpleConnectionPoolDataSource(String configFile)
        ...
        url = props.getProperty("chapterexercise.ch16.url");
        username = props.getProperty("chapterexercise.ch16.username");
        password = props.getProperty("chapterexercise.ch16.password");
        max = Integer.parseInt(props.getProperty("chapterexercise.ch16.poolmax"));
